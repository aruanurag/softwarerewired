...
1. **Run the pro‑worker test.** Does your system make users more capable, level access to expertise, or mostly remove humans from the loop?
2. **Design for real workflows.** Make verification cheap, obvious, and fast.
3. **Manage risk like an engineering discipline.** Use structured frameworks such as the NIST AI RMF.
4. **Build on human‑centered principles.** The OECD AI Principles are a strong baseline for what “trustworthy AI” means.
...
- Pew Research Center: U.S. workers’ views on AI in the workplace (Feb 25, 2025) – [U.S. Workers Are More Worried Than Hopeful About Future AI Use in the Workplace](https://www.pewresearch.org/social-trends/2025/02/25/u-s-workers-are-more-worried-than-hopeful-about-future-ai-use-in-the-workplace/)
...
- Brynjolfsson, Li, & Raymond (NBER Working Paper 31161): [Generative AI at Work](https://www.nber.org/papers/w31161)
- Peng et al. (2023), arXiv: [The Impact of AI on Developer Productivity](https://arxiv.org/abs/2302.06590)
- Jumper et al. (2021), *Nature*: [Highly accurate protein structure prediction with AlphaFold](https://www.nature.com/articles/s41586-021-03819-2)
- EMBL-EBI / DeepMind: [AlphaFold Protein Structure Database — 200M+ predictions](https://www.embl.org/news/science/alphafold-200-million/)
- Stokes et al. (2020), *Cell*: [A Deep Learning Approach to Antibiotic Discovery](https://doi.org/10.1016/j.cell.2020.01.021)
- Klinova & Korinek (2021): [AI and Shared Prosperity](https://arxiv.org/abs/2105.08475)
- Acemoglu, Autor, Johnson (2026), Brookings: [Building pro-worker AI](https://www.brookings.edu/articles/building-pro-worker-ai/)
- World Bank (Jul 12, 2023): [Progress, challenges in ending extreme poverty](https://blogs.worldbank.org/en/opendata/progress-challenges-ending-extreme-poverty)
- UNESCO (Sep 7, 2023; updated Jan 16, 2026): [Guidance for generative AI in education and research](https://www.unesco.org/en/articles/guidance-generative-ai-education-and-research)
- NIST (Jan 26, 2023): [AI Risk Management Framework (AI RMF 1.0)](https://www.nist.gov/publications/artificial-intelligence-risk-management-framework-ai-rmf-10)
- OECD AI Principles: [AI principles](https://www.oecd.org/en/topics/ai-principles.html)
